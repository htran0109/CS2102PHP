...
VALUES('kate', 'adam', 'start1', 'end1', '2030-01-01', '01:00:00', 1);

INSERT INTO Bid(Bidder, Owner, Start, Dest, depDate, depTime, Customers)
VALUES('kate', 'bob', 'start2', 'end2', '2030-01-01', '02:00:00', 1);

INSERT INTO Bid(Bidder, Owner, Start, Dest, depDate, depTime, Customers)
VALUES('kate', 'carl', 'start3', 'end3', '2030-01-01', '03:00:00', 1);

INSERT INTO Bid(Bidder, Owner, Start, Dest, depDate, depTime, Customers)
VALUES('kate', 'doug', 'start4', 'end4', '2030-01-01', '04:00:00', 1);

INSERT INTO Bid(Bidder, Owner, Start, Dest, depDate, depTime, Customers)
VALUES('kate', 'ellie', 'start5', 'end5', '2030-01-01', '05:00:00', 1);

INSERT INTO Bid(Bidder, Owner, Start, Dest, depDate, depTime, Customers)
VALUES('kate', 'francis', 'start6', 'end6', '2030-01-01', '06:00:00', 1);

INSERT INTO Bid(Bidder, Owner, Start, Dest, depDate, depTime, Customers)
VALUES('kate', 'george', 'start7', 'end7', '2030-01-01', '07:00:00', 1);

INSERT INTO Bid(Bidder, Owner, Start, Dest, depDate, depTime, Customers)
VALUES('kate', 'harry', 'start8', 'end8', '2030-01-01', '08:00:00', 1);

INSERT INTO Bid(Bidder, Owner, Start, Dest, depDate, depTime, Customers)
VALUES('kate', 'irene', 'start9', 'end9', '2030-01-01', '09:00:00', 1);

INSERT INTO Bid(Bidder, Owner, Start, Dest, depDate, depTime, Customers)
VALUES('kate', 'joe', 'start10', 'end10', '2030-01-01', '10:00:00', 1);