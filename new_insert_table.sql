...
VALUES ('george', 'george', 'georgeson', '11111111', 'george@gmail.com', 'foobar' ,'1990-01-01');

INSERT INTO profile(username, first_name, last_name, mobile_number, email, password, birthday)
VALUES ('bill', 'bill', 'billson', '20562046', 'bill@gmail.com', 'foobar' ,'1990-01-01');

INSERT INTO profile(username, first_name, last_name, mobile_number, email, password, birthday)
VALUES ('adam', 'adam', 'adamson', '30012981', 'adam@gmail.com', 'foobar' ,'1990-01-01');

INSERT INTO profile(username, first_name, last_name, mobile_number, email, password, birthday)
VALUES ('bob', 'bob', 'bobson', '39463916', 'bob@gmail.com', 'foobar' ,'1990-01-01');

INSERT INTO profile(username, first_name, last_name, mobile_number, email, password, birthday)
VALUES ('carl', 'carl', 'carlson', '48914851', 'carl@gmail.com', 'foobar' ,'1990-01-01');

INSERT INTO profile(username, first_name, last_name, mobile_number, email, password, birthday)
VALUES ('doug', 'doug', 'dougson', '58365786', 'doug@gmail.com', 'foobar' ,'1990-01-01');

INSERT INTO profile(username, first_name, last_name, mobile_number, email, password, birthday)
VALUES ('ellie', 'ellie', 'ellieson', '67816721', 'ellie@gmail.com', 'foobar' ,'1990-01-01');

INSERT INTO profile(username, first_name, last_name, mobile_number, email, password, birthday)
VALUES ('francis', 'francis', 'francisson', '77267656', 'francis@gmail.com', 'foobar' ,'1990-01-01');

INSERT INTO profile(username, first_name, last_name, mobile_number, email, password, birthday)
VALUES ('harry', 'harry', 'harryson', '86718591', 'harry@gmail.com', 'foobar' ,'1990-01-01');

INSERT INTO profile(username, first_name, last_name, mobile_number, email, password, birthday)
VALUES ('irene', 'irene', 'ireneson', '96169526', 'irene@gmail.com', 'foobar' ,'1990-01-01');

INSERT INTO profile(username, first_name, last_name, mobile_number, email, password, birthday)
VALUES ('joe', 'joe', 'joeson', '15620462', 'joe@gmail.com', 'foobar' ,'1990-01-01');

INSERT INTO profile(username, first_name, last_name, mobile_number, email, password, birthday)
VALUES ('kate', 'kate', 'kateson', '25071397', 'kate@gmail.com', 'foobar' ,'1990-01-01');
...
VALUES ('car1', 'george', '1', 'start1', 'end1', '2030-01-01', '01:00:00');

INSERT INTO post(license_plate, owner, seats_available, origin, destination, depart_date, depart_time)
VALUES ('car2', 'bill', '2', 'start2', 'end2', '2030-01-02', '02:00:00');

INSERT INTO post(license_plate, owner, seats_available, origin, destination, depart_date, depart_time)
VALUES ('car3', 'adam', '3', 'start3', 'end3', '2030-01-03', '03:00:00');

INSERT INTO post(license_plate, owner, seats_available, origin, destination, depart_date, depart_time)
VALUES ('car4', 'bob', '4', 'start4', 'end4', '2030-01-04', '04:00:00');

INSERT INTO post(license_plate, owner, seats_available, origin, destination, depart_date, depart_time)
VALUES ('car5', 'carl', '5', 'start5', 'end5', '2030-01-05', '05:00:00');

INSERT INTO post(license_plate, owner, seats_available, origin, destination, depart_date, depart_time)
VALUES ('car6', 'doug', '1', 'start1', 'end1', '2030-01-01', '01:00:00');

INSERT INTO post(license_plate, owner, seats_available, origin, destination, depart_date, depart_time)
VALUES ('car7', 'ellie', '2', 'start2', 'end2', '2030-01-02', '02:00:00');

INSERT INTO post(license_plate, owner, seats_available, origin, destination, depart_date, depart_time)
VALUES ('car8', 'francis', '3', 'start3', 'end3', '2030-01-03', '03:00:00');

INSERT INTO post(license_plate, owner, seats_available, origin, destination, depart_date, depart_time)
VALUES ('car9', 'harry', '4', 'start4', 'end4', '2030-01-04', '04:00:00');

INSERT INTO post(license_plate, owner, seats_available, origin, destination, depart_date, depart_time)
VALUES ('car10', 'irene', '5', 'start5', 'end5', '2030-01-05', '05:00:00');

INSERT INTO post(license_plate, owner, seats_available, origin, destination, depart_date, depart_time)
VALUES ('car11', 'joe', '1', 'start1', 'end1', '2030-01-01', '01:00:00');

INSERT INTO post(license_plate, owner, seats_available, origin, destination, depart_date, depart_time)
VALUES ('car12', 'kate', '2', 'start2', 'end2', '2030-01-02', '02:00:00');
